...
const Dropdown: FC<DropdownProps> = ({
  ...
  return (
    <Menu as='div' className='relative inline-block'>
      ...
      >
        {({ open }) => (
          <>
            {label}
            <ChevronDownIcon
              className={clsx('-mr-1 ml-2 h-5 w-5 transition text-white', {
                'rotate-180': open,
              })}
              aria-hidden='true'
            />
      ...
      >
        <Menu.Items className='absolute right-0 z-10 mt-2 min-w-full max-w-52 origin-top focus:outline-none bg-white shadow-sm rounded-md border-1'>
          <div className='py-1'>
